...
svgLegend.append("circle").attr("cx",140).attr("cy",50).attr("r", 8).attr("id", "bubble1").style("fill", "#ffffcc");
svgLegend.append("circle").attr("cx",160).attr("cy",50).attr("r", 8).attr("id", "bubble2").style("fill", "#ffefa5")
svgLegend.append("circle").attr("cx",180).attr("cy",50).attr("r", 8).attr("id", "bubble3").style("fill", "#fedc7f")
svgLegend.append("circle").attr("cx",200).attr("cy",50).attr("r", 8).attr("id", "bubble4").style("fill", "#febf5b")
svgLegend.append("circle").attr("cx",220).attr("cy",50).attr("r", 8).attr("id", "bubble5").style("fill", "#fd9d43")
svgLegend.append("circle").attr("cx",240).attr("cy",50).attr("r", 8).attr("id", "bubble6").style("fill", "#fc7034")
svgLegend.append("circle").attr("cx",260).attr("cy",50).attr("r", 8).attr("id", "bubble7").style("fill", "#f23d26")
svgLegend.append("circle").attr("cx",280).attr("cy",50).attr("r", 8).attr("id", "bubble8").style("fill", "#d91620")
svgLegend.append("circle").attr("cx",300).attr("cy",50).attr("r", 8).attr("id", "bubble9").style("fill", "#b40325")
svgLegend.append("circle").attr("cx",320).attr("cy",50).attr("r", 8).attr("id", "bubble10").style("fill", "#800026")
